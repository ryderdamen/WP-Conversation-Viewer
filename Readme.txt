...
Conversation Viewer is a responsive WordPress plugin for displaying chat conversations between people as if in their native apps. It allows you to write up conversations between two, or groups of more than two people, without having to take screenshots. These conversations can be easily switched into various messaging app styles. The current styles supported are:
